...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.getElementById("model1-btn").addEventListener("click", () => { currentModel = 1; updateModelInfo(); });
    document.getElementById("model2-btn").addEventListener("click", () => { currentModel = 2; updateModelInfo(); });
